...
// ListOptions encapsulates common query parameters for WHOOP collection endpoints.
...
// Validate ensures the option values are consistent before being sent to WHOOP.
...
// Page represents a paginated WHOOP response where records are accompanied by a next_token.
